...
//#region vars
    ...
    private var playerContainer:FlxGroup;
//#endregion
...
//#endregion
        ...
        player.animation.addByPrefix("idle", "0_idle", 0, true); // '0_idle' is the prefix common in all frames
...
//#endregion
        ...
        playerContainer = new FlxGroup();

        // Add player, playerCircle, and playerName to playerContainer
        playerContainer.add(player);
        playerContainer.add(playerCircle);
        playerContainer.add(playerName);

        // Add playerContainer to the state
        add(playerContainer);        
    }
